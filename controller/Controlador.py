...
class Controlador:
    ...
    def __inicializar_criterios(self):
        ...
        self.criterios = [Criterio("Desarrollo y profundidad en el tratamiento del tema", 0.2),
                 ...
                 Criterio("Calidad y presentacion verbal, manejo del espacio; Nuevo criterio", 0.05)]
    ...
    def directores(self):
        directores = ["Luisa Fernanda Rincon", "Juan Carlos Martinez", "Maria Constanza Pabon",
                      "Gloria Inés Álvarez", "Gerardo M Sarria M", "Luis Eduardo Tobón", "Juan Pablo García",
                      "Frank Martinez", "Carlos Ramirez"]
